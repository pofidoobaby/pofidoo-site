...
function Logo({ dark, size = 22 }) {
  const ink = dark ? COLORS.cream : COLORS.harbor;
  return (
    <span style={{ fontFamily: "Poppins, sans-serif", fontWeight: 700, fontSize: size, color: ink, position: "relative", display: "inline-flex", alignItems: "center" }}>
      <span style={{ position: "absolute", top: -size * 0.62, left: size * 1.55, fontSize: size * 0.6, color: COLORS.bloom }}>♥</span>
      pofidoo
    </span>
  );
}
